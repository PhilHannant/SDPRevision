...
object test extends App{
  ...
  object Draw {
    ...
    def getCol(shape: Shape): String = shape.getColour.getClass.getSimpleName match {
      case "Red" => "Red"
      case "Yellow" => "Yellow"
      case "Pink" => "Pink"
      case _ => lightDark(shape.getColour)
    }
  }
  ...
  val d2 = Draw
  d2.apply(Circle(10)) is "A circle of radius 10 colour is Red"

print(Circle(10).getColour.getClass.getSimpleName)
